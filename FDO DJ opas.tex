...
\newfontfamily\blackfont        [Ligatures=TeX]{MyriadPro-Black}
\newfontfamily\lightfont        [Ligatures=TeX]{MyriadPro-Light}
\newfontfamily\semiboldfont     [Ligatures=TeX]{MyriadPro-SemiBold}

\setmainfont[Ligatures=TeX,Numbers=Lining]{MyriadPro}[
    BoldFont = *-Bold,
...
\AtBeginEnvironment{tabular}{
    \setmainfont[Numbers=Monospaced]{MyriadPro}[
        BoldFont = *-Bold,
        BoldItalicFont = *-BoldIt,
        ItalicFont = *-It,
        UprightFont = *-Regular,
...
\begin{titlepage}
    ...
    {\Huge \blackfont DJ OPAS \par \vspace{5mm}}
...
Yhteiskierroksen biisi voi puolestaan olla erilainen ja eri tempolla.
Biisien nopeutuksessa kannattaa kuitenkin pitäytyä kohtuuden rajoissa,
ja nyrkkisääntönä nostaa kappaleiden tempoa maksimissaan kahdeksan prosentin verran.
Alunperin 90 iskua minuutissa olevasta biisistä ei siis kannata väkisin yrittää tehdä duo- tai pienryhmäbiisiä.
